        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {baseProducts.map((product) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col justify-between h-[calc(100%-16rem)]"> {/* Added flex-col and height */}
                <div>
                ...
                {/* Updated button and price layout for better spacing and responsiveness */}
                <div className="flex flex-col sm:flex-row justify-between items-center mt-auto pt-4 border-t border-gray-100 dark:border-gray-600"> {/* mt-auto pushes to bottom */}
